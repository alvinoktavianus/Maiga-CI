<article class="content responsive-tables-page">
    ...
    <section class="section">
        ...
        <div class="card card-block">
            ...
            <?php echo form_open_multipart(base_url().'admin/do_createassignment', array( 'novalidate' => true )); ?>
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-md-offset-3">
                    ...
                    <div class="form-group row">
                        <?php echo form_label('Ditugaskan Untuk', 'assignedfor', array( 'class' => 'col-sm-4 form-control-label' )); ?>
                        <div class="col-sm-8">
                            <?php
                                $options = array(
                                    '' => '',
                                ...
                                if ($this->session->flashdata('assignedfor'))
                                    echo form_dropdown('assignedfor', $options, $this->session->flashdata('assignedfor'), array( 'id' => 'assignedfor', 'class' => 'form-control' ));
                                else
                                    echo form_dropdown('assignedfor', $options, '', array( 'id' => 'assignedfor', 'class' => 'form-control' ));
                            ?>
                        </div>
                    </div>
