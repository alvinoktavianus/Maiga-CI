<article class="content responsive-tables-page">
    ...
    <section class="section">
        ...
        <div class="card card-block">
                ...
                <?php echo form_open_multipart(base_url().'admin/do_register', array( 'novalidate' => true )); ?>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-md-offset-3">
                        ...
                        <div class="form-group row">
                            <?php echo form_label('Nama Lengkap', 'name', array( 'class' => 'col-sm-4 form-control-label' )); ?>
                            <div class="col-sm-8">
                        ...
                        <div class="form-group row">
                            <?php echo form_label('Mulai Bekerja', 'startwork', array( 'class' => 'col-sm-4 form-control-label' )); ?>
                            <div class="col-sm-8">
                        ...
                        <div class="form-group row">
                            <?php echo form_label('Status Karyawan', 'status', array( 'class' => 'form-control-label col-sm-4' )); ?>
                            <div class="col-sm-8">
                                <?php
                                    $data = array(
                                        'Aktif' => 'Aktif',
                        ...
                        <div class="form-group row">
                            <?php echo form_label('Pegawai Kontrak?', 'iscontract', array( 'class' => 'form-control-label col-sm-4' )); ?>
                            <div class="col-sm-8">
                                <?php
                                    $data = array(
                                        'Y' => 'Ya',
                        ...
                        <div class="form-group row">
                            <?php echo form_label('Peran', 'role', array( 'class' => 'form-control-label col-sm-4' )); ?>
                            <div class="col-sm-8">
                                <?php 
                                    $data = array(
                                        'adm' => 'Administrator',
